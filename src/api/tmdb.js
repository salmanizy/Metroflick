...
export const searchCrews = async (query) => {
  const response = await tmdbApi.get('/search/person', {
    params: {query},
  });
  return response.data.results;
...
export const fetchCrewDetails = async (id) => {  
  const response = await tmdbApi.get(`/person/${id}`);
  return response.data;
};

export const fetchCrewMovies = async (id) => {  
  const response = await tmdbApi.get(`/person/${id}/movie_credits`);
  return response.data;
};

export const fetchCrewSeries = async (id) => {  
  const response = await tmdbApi.get(`/person/${id}/tv_credits`);
  return response.data;
};
...
export const fetchSomeoneSocmed = async (castId) => {
  const response = await tmdbApi.get(`/person/${castId}/external_ids`);    
  return response.data;
};